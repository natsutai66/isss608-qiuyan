...
In this hands-on exercise, we will using R to plot static and interactive heatmap for visualising and analysing multivariate data.
...
Next, I need to change the rows by country name instead of row number by using the code chunk below
...
In this section, I will learn how to plot static heatmaps by using **heatmap()** of *R Stats*package.
