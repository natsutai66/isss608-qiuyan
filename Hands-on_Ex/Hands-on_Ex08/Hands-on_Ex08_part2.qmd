...
In this hands-on exercise, we will learn by using appropriate R packages:
...
## 1 It all started with an interactive point symbol map
...
## 3 Lets give it a different colour
