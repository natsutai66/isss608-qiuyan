...
This exercise demonstrates two statistical graphic methods for visualising distribution, namely **ridgeline** plot and **raincloud** plot by using ggplot2 and its extensions.
...
![](images/clipboard-3610526361.png)
...
In this section, raincloud plot is created to visualise the distribution of English score by race. It will be created by using functions provided by **ggdist** and ggplot2 packages.
...
Kam, Tin Seong. (December 14, 2024). 9 Visualising Distribution. R for Visual Analytics. r4va.netlify.app
