...
reactablefmtr, gt, gtExtras, tidyverse, gganimate, ggalt, svglite)
```
...
In this section, we will learn how to create static information dashboard by using gt and gtExtras packages.
