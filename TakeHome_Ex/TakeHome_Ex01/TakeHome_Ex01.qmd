...
The code chunk imports the dataset `respopagesex2024.csv` and load the CSV file into a dataframe named `population_data`.
...
pyramid_data_grouped <- population_data %>%
  ...
  mutate(
    AgeGroup = factor(AgeGroup, levels = c("Children", "Teenager", 
                                           "Young Adult", "Adult", "Middle-age", "Elderly")),
...
Kam, Tin Seong. (2025). Beyond ggplot2 Fundamentals. R for Visual Analytics. https://r4va.netlify.app/chap02
